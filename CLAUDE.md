...
- ❌ No prender `CHECKOUT_ENABLED` (`src/lib/billing/plan.ts`) sin que el dueño lo pida — el cobro se activa **una sola vez y todo junto**: monotributo, Vercel Pro (Hobby prohíbe el uso comercial), precio real y lo legal de `H6`. Ver `docs/LANZAMIENTO.md`
