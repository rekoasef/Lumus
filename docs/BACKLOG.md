...
- **Estilo**: pedido *"moderno, estilo Apple/Tesla, con efectos de scroll y el orbe vivo y brilloso"*. Hero con el orbe (`living-orb.tsx`: aros que giran, partículas, sigue al puntero con resorte), gastos sueltos que al bajar vuelan y se ordenan de mayor a menor en una tarjeta (`expense-sort-scene.tsx`, reemplazó a una frase que se encendía palabra por palabra y al dueño no le gustó; el 2026-09-17 pasó de avanzar con el scroll a reproducirse sola en una pantalla, porque los testers sintieron mucho scroll), tarjeta de informe que se endereza al bajar y cuyo análisis se escribe solo, calculadora con curva animada, grilla con luz que sigue al puntero, precio y preguntas frecuentes.
